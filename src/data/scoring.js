/* Come i music show calcolano il punteggio settimanale.
   ...
   i fan possono contribuire. In ogni show le fette hanno la percentuale
   e la fonte del dato. */
...
export const SCORING = [
  {
    ...
    slices: [
      ...
      { key: "sns", pct: 5, detail: { it: "Visualizzazioni MV, TikTok", en: "MV views, TikTok" } },
  ...
  },
  {
    ...
    slices: [
      ...
      { key: "prevote", pct: 5, apps: ["linc"] },
      { key: "livevote", pct: 5, apps: ["higher"] },
    ],
  },
  {
    show: "core",
    slices: [
      ...
      { key: "prevote", pct: 10, apps: ["mubeat", "muniverse"] },
      {
        ...
        detail: { it: "Voto via SMS: solo dalla Corea", en: "Text vote: Korea only" },
      },
      { key: "committee", pct: 5, detail: { it: "Sito MBC, solo dalla Corea", en: "MBC website, Korea only" } },
    ],
  },
  {
    show: "mcountdown",
    slices: [
      ...
      { key: "sns", pct: 15, detail: { it: "Visualizzazioni MV e short form", en: "MV views and short form" } },
