...
export const UI = {
  it: {
    ...
    viewScoring: "Music Show",
    scoringIntro: "ⓘ Ogni settimana i Music Show sommano punti provenienti da fonti diverse e proclamano un vincitore. " +
        "I criteri e il loro peso cambiano da programma a programma: qui trovi la composizione di ciascuno.",
    criteriaTitle: "I criteri",
    starNote: "",
    pickShow: "Scegli un Music Show",
    scoringFoot: "⚠ I Music Show possono cambiare i criteri di stagione in stagione.",
    viewLabel: "Sezione",
  ...
  en: {
    ...
    viewScoring: "Music Shows",
    scoringIntro: "ⓘ Each week, Music Shows calculate points from different sources and crown a winner. " +
        "The criteria and their weight vary from show to show: here’s how the score is calculated for each one.",
    criteriaTitle: "The criteria",
    starNote: "",
    pickShow: "Pick a show",
    scoringFoot: "⚠ Music Shows can change their criteria from season to season.",
    viewLabel: "Section",
